...
if ($_SERVER['REQUEST_METHOD'] === 'POST')
{
    ...
    $sql = "INSERT INTO student_basicdetails (student_id, student_name, student_email, student_mobile, student_address, student_bio, student_degree, student_yearofpassing, student_percentage, student_skill, student_certificate, student_hobby, student_achievements, student_kl, student_project, student_internship, student_companyname, student_companyaddress)VALUES 
    ($student_id, '$student_name', '$student_email', '$student_mobile', '$student_address', '$student_bio', '$student_degree', '$student_yearofpassing', '$student_percentage', '$student_skill', '$student_certificate', '$student_hobby', '$student_achievements', '$student_kl', '$student_project', '$student_internship', '$student_companyname', '$student_companyaddress')";
...
$query = "SELECT * FROM student_basicdetails ";
            ...
            <div class="bg-light lter b-b wrapper-md mb-10">
                <div class="row">
                    <div class="col-sm-6 col-xs-12">
                        <h1 class="font-thin h3 m-0">Fill up the below form</h1>
                    ...
                    <section class="boxs">
                        ...
                        <div class="boxs-body">
                            <form class="form-horizontal" action="" method="post" role="form">
                                <?php  include_once('./forms/basicdetails_form_add.php'); ?>
                            </form>
                        </div>
                    </section>
                </div>
