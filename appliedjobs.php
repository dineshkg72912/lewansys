...
$query = "SELECT job_id,job_title,company_name, location, skills, start_salary, end_salary, description   
FROM applied_job  
LEFT JOIN jobs  
ON applied_job.job_id = jobs.id WHERE student_id = '$student_id'";
					...
					<div class="panel panel-default">						
						<div id="leftmenuNav" class="panel-collapse collapse in" role="tabpanel">
							<div class="panel-body"> 
								...
								<li class="active open"> <a role="button" tabindex="0"><i class="fa fa-list"></i> <span>Applied Jobs</span></a>
			...
			<div class="bg-light lter b-b wrapper-md mb-10">
				<div class="row">
					<div class="col-sm-6 col-xs-12">
						<h1 class="font-thin h3 m-0"><?php echo $count ?> Applied Jobs</h1>
						<small class="text-muted">You have applied for the below jobs</small>
					</div>
				</div>
			</div>
			<div class="row">
							...
							<ul class="search-results fulltext">
												<li class="search-result">
													<div class="cover">
														...
														<button class="btn btn-raised btn-primary">View Job Description</button>
														<a href="selectionprocess.php?company_id=<?php echo $row['job_id']; ?>">
														<button class="btn btn-raised btn-primary">Track Status</button>
														</a>
